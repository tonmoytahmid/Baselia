...
class Uploadcoverscreen extends StatefulWidget {
  const Uploadcoverscreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Preview Cover Picture", style: TextStyle(color: Colors.black)),
          ...
          child: Column(
            ...
            builder: (controller) {
              ...
              Padding(
                padding:  EdgeInsets.symmetric(horizontal: 20),
                child: ElevatedButton(
                  onPressed:()=> uploadcoverImage.uploadAndUpdateCover(uid, ),
                  style: ElevatedButton.styleFrom(
