...
class Fatchingforumstopcomments extends StatefulWidget {
  String postId;

  Fatchingforumstopcomments({super.key, required this.postId});

  @override
  State<Fatchingforumstopcomments> createState() => _FatchingforumstopcommentsState();
}

class _FatchingforumstopcommentsState extends State<Fatchingforumstopcomments> {
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    icon: Icon(
                                      comment['reactions'].containsKey(auth!.uid)
                                          ? Icons.favorite
                                          : Icons.favorite_border,
                                      color: comment['reactions'].containsKey(auth!.uid)
                                          ? Colors.red
                                          : Colors.grey,
                                    ),
                                  ),
